...
export const canisterId = process.env.CANISTER_ID_ICRC1;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icrc1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icrc1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icrc1.did.js")._SERVICE>}
 */
